  ...
  return (
    <div className={styles.homeData}>
      ...
      <h3 className={styles.homeSubtitle}>
        Web Developer with experience in project managemnet and customer service
      </h3>
      <p className={styles.homeDescription}>
        I am a self-learning MERN stack developer with a bachelor's degree in
        arts and education majoring in English. I am passionate about web
