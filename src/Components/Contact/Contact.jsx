      ...
      <div className={`${styles.contactContainer} grid container`}>
        <div className={styles.contactContent}>
          ...
          <div className={styles.contactInfo}>
            <div className={styles.contactCard}>
              ...
              <a
                href="mailto:israsalama4@gmail.com"
                className={styles.contactButton}
              >
                Contact me
                <i
                  className={`bx bx-right-arrow-alt ${styles.contatcButtonIcon}`}
                ></i>
              </a>
            </div>

            <div className={styles.contactCard}>
              <i className={`bx bxl-whatsapp ${styles.contactCardIcon}`}></i>
              <h3 className={styles.contactCardTitle}>Whatsapp</h3>
              <span className={styles.contactCardData}>+971566639861</span>
              <a
                href="https://wa.me/971566639861"
                className={styles.contactButton}
              >
                Contact me
                <i
        ...
        <div className={styles.contactContent}>
          ...
          <form ref={form} onSubmit={sendEmail} className={styles.contactForm}>
            ...
            <div className={styles.contactFormDiv}>
              <label className={styles.contactFormTag}>Email</label>
              <input
                type="email"
                name="email"
                className={styles.contactFormInput}
            ...
            <div
              className={`${styles.contactFormDiv} ${styles.contactFormTextarea}`}
            >
              <label className={styles.contactFormTag}>Message</label>
              <textarea
                name="message"
                cols="30"
                rows="10"
